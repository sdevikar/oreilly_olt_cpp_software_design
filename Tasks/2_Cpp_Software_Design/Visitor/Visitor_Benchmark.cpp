      ...
      for( auto const& shape : shapes )
      {
         switch( shape->type )
         {
            ...
            case ShapeType::circle:
               translate( static_cast<Circle&>( *shape.get() ), v );
               break;
#endif
#if BENCHMARK_WITH_ELLIPSE
            case ShapeType::ellipse:
               translate( static_cast<Ellipse&>( *shape.get() ), v );
               break;
#endif
#if BENCHMARK_WITH_SQUARE
            case ShapeType::square:
               translate( static_cast<Square&>( *shape.get() ), v );
               break;
#endif
#if BENCHMARK_WITH_RECTANGLE
            case ShapeType::rectangle:
               translate( static_cast<Rectangle&>( *shape.get() ), v );
               break;
#endif
#if BENCHMARK_WITH_PENTAGON
            case ShapeType::pentagon:
               translate( static_cast<Pentagon&>( *shape.get() ), v );
               break;
#endif
#if BENCHMARK_WITH_HEXAGON
            case ShapeType::hexagon:
               translate( static_cast<Hexagon&>( *shape.get() ), v );
               break;
#endif
         }
      }
