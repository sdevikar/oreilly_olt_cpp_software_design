...
int main()
{
   ...
   shapes.emplace_back( std::make_unique<Circle>( 2.3, GLDrawer(gl::Color::red) ) );
   shapes.emplace_back( std::make_unique<Square>( 1.2, GLDrawer(gl::Color::green) ) );
   shapes.emplace_back( std::make_unique<Circle>( 4.1, GLDrawer(gl::Color::blue) ) );
