...
{
 protected:
   explicit ElectricCar( std::unique_ptr<ElectricCarImpl> impl )  // Dependency Injection
...
{
 public:
   Model10( std::unique_ptr<ElectricCarImpl>&& impl );  // Dependency Injection
...
Model10::Model10( std::unique_ptr<ElectricCarImpl>&& impl )
...
class Model10Impl : public eh::ElectricCarImpl
{
 public:
...
int main()
{
   eh::Model10 model10{ std::make_unique<Model10Impl>( 100.0 ) };
   model10.drive();
