...
*
* Step 1: Refactor the given 'Shape' hierarchy by means of the strategy design pattern to enable
*         the runtime configuration of the draw() operation.
*
...
class Circle : public Shape
{
 public:
   ...
   std::string serialize() const override { return serializer_->serialize(*this); }
